...
class MailjetCollector(object):
  ...
  def __init__(self, api_key_private, api_key_public):
        ...
        self.endpoint = '/v3/REST/statcounters'
  ...
  def collect(self):
    ...
    payload = {'CounterSource': 'APIKey', 'CounterTiming': 'Message', 'CounterResolution': 'Highest', 'FromTS': now_minus_delta.strftime(dateTimeRqFormat) , 'ToTS': now.strftime(dateTimeRqFormat)} 
